...
<head>
    ...
    <title>Altera Palestrantes</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="shadow p-3 mb-5 bg-white rounded">
                        <form action="DataBase/DB_AlterarPalestrante.php" method="POST">
                            <div class="container-contact2">
                                <div class="wrap-contact2">

                                    <span class="contact2-form-title">
                                        Alterar Palestrantes
                                    </span>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01" required>Area de
                                                Atuaçao</label>
                                        </div>
                                    ...
                                    <?php echo'<input type="hidden" name="palest_id" value='.$id.'>';?>
                                    <div class="container-contact2-form-btn">
                                        <div class="wrap-contact2-form-btn">
                                            <div class="contact2-form-bgbtn"></div>
                                            <button class="btn btn-primary" type="submit"
                                                name="DataBase/DB_AlterarPalestrante.php">Atualizar Dados</button>
                                            <a href="GerenciarPalestrante.php" class="btn btn-secondary">Voltar</a>
                                        </div>
                                    </div>
                        </form>
                    </div>

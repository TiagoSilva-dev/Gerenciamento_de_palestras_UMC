...
if (!empty($_GET['idLocal'])) {
    $id_local = $_REQUEST['idLocal'];
}
if (!empty($_POST)) {
    $sala_id = $_POST['sala_id'];

    $sql = "DELETE FROM sala where sala_id = '$sala_id'";
    $conexao->query($sql);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="painel.php">
                ...
                <?php echo '<div class="sidebar-brand-text mx-3">' . $_SESSION['nome'] . '</div>'; ?>
            </a>
            <!-- Divider -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="span10 offset1">
                            <div class="">
                                <h3 class="well">Excluir Locais </h3>
                            </div>
                            <form class="form-horizontal" action="ExcluirLocais.php" method="post">
                                <?php echo '<input type="hidden" name="sala_id" value=' . $id_local . '"/>'; ?>
                                <div class="alert alert-danger"> Deseja excluir o Local?
                                </div>
                                <div class="form actions">
                                    <button type="submit" class="btn btn-danger">Sim</button>
                                    <a href="locais.php" class="btn btn-secondary">Não</a>
                                </div>
                            </form>
                        </div>
                    </div>

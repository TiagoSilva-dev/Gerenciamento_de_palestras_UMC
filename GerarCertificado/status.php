    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Painel.php">
                ...
                <?php echo '<div class="sidebar-brand-text mx-3"></div>'; ?>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="locais.php">
                    ...
                    <span style="font-size: 15px">Salas</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h4 class="alert-heading">Certificado enviado com Sucesso!</h4>
                    <a class="btn btn-primary" href="CadastrarCoordenador.php">Voltar</a>
                    <a class="btn btn-secondary" href="painel.php">Inicio</a>
                    <hr>

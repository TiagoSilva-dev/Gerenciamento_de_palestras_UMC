...
if (!empty($_POST)) {
    $delete_id = $_POST['deletar'];
    $sql = "DELETE FROM palestrante where palest_id = '$delete_id'";
    $conexao->query($sql);
    header('Location: GerenciarPalestrante.php');
}
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <title>Gerenciar Palestrantes</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <center>
                        ...
                        <a class="btn btn-success" href="CadastrarPalestrante.php"><i class="fas fa-plus"><span>Adicionar</span></i></a></br>
                        <hr>
                        <div class="shadow p-3 mb-5 bg-white rounded">
                            <div class="table-responsive table-hover">
                                <table id="userList" class="table table-sm ">
                                    ...
                                    <form action="GerenciarPalestrante.php" method="POST">
                                        <?php
                                        ...
                                        while ($registro = mysqli_fetch_array($resultado)) {
                                            echo '<td>' . $registro['palest_id'] . '</td>';
                                            echo "<td>" . $registro['palest_nome'] . "</td>";
                                            echo "<td>" . $registro['palest_email'] . "</td>";
                                            echo '<td width=200>';
                                            echo '<a title="Alterar" href="AlterarPalestrantes.php?id=' . $registro['palest_id'] . '"><span style="color:blue">Alterar</span></a>';
                                            echo ' | ';
                                            echo '<a title="Excluir" href="ExcluirPalestrantes.php?id=' . $registro['palest_id'] . '"><span style="color:red">Excluir</span></a>';
                                            echo ' ';
                                            echo '</td>';
                                            echo "</tr>";
                                        }

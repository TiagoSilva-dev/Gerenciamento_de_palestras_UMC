                            ...
                            <div class="shadow p-3 mb-5 bg-white rounded">
                                <div class="table-responsive table-hover">
                                    <table class="table table-sm">
                                        ...
                                        $sql = "SELECT
                  evento_nome,palest_nome,sala_local,DATE_FORMAT (`evento_data`,'%d/%m/%Y')evento_data,DATE_FORMAT (`evento_hora_ini`,'%H:%i')evento_hora_ini,DATE_FORMAT (`evento_hora_ter`,'%H:%i')evento_hora_ter
                from
                  sala inner join alocados
                on sala.sala_id = alocados.sala_sala_id
                inner join evento
                on evento.id_evento = alocados.evento_id_evento
                inner join palestrante
                on palestrante.palest_id = evento.palestrante_palest_id order by evento_data";

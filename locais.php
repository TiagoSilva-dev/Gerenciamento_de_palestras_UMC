        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"><center>
                    <!-- CONTEUDO AKI -->
                    <center><a class="btn btn-success" href="Alocar.php"><i class="fas fa-plus"><span>Adicionar</span></i></a>
                    <div class="shadow p-3 mb-5 bg-white rounded">
                    <center><a href="locais.php"><h1 class="display-4">Gerenciar Locais </h1><br>
                    <div class="table-responsive table-hover">
                        ...
                        <thead class="thead-dark">
                            ...
                            while ($registro = mysqli_fetch_array($resultado)) {
                                echo '<td>' . $registro['sala_id'] . '</td>';
                                echo "<td>" . $registro['sala_numero'] . "</td>";
                                echo "<td>" . $registro['sala_local'] . "</td>";
                                echo "<td>" . $registro['sala_capacidade'] . "</td>";
                                echo '<td width=200>';
                                echo '<a title="Alterar" href="AlterarLocais.php?idLocal=' . $registro['sala_id'] . '"><span style="color: blue;">Alterar</a>';
                                echo ' | ';
                                echo '<a title="Excluir" href="ExcluirLocais.php?idLocal=' . $registro['sala_id'] . '"><span style="color: red;">Excluir</a>';
                                echo ' ';
                                echo '</td>';
                                echo "</tr>";
                            }
